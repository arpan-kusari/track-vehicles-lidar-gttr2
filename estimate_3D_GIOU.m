...
bb_detection_2D = [detection.X - detection.Sx/2,...
                          detection.Y - detection.Sy/2,...
                          detection.X + detection.Sx/2,...
                          detection.Y + detection.Sy/2,...
                          detection.Rot];
...
height_enclosed = max(track_Z + track_Sz, detection.Z + detection.Sz) - min(track_Z - track_Sz, detection.Z - detection.Sz);
...
height_overlap = min(track_Z + track_Sz, detection.Z + detection.Sz) - max(track_Z - track_Sz, detection.Z - detection.Sz);
