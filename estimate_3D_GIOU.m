...
bb_detection_2D = [detection.XTV - detection.Sx/2,...
                          detection.YTV - detection.Sy/2,...
                          detection.XTV + detection.Sx/2,...
                          detection.YTV + detection.Sy/2,...
                          detection.RotV];
...
height_enclosed = max(track_Z + track_Sz, detection.ZTV + detection.Sz) - min(track_Z - track_Sz, detection.ZTV - detection.Sz);
...
height_overlap = min(abs(track_Z) + track_Sz/2, abs(detection.ZTV) + detection.Sz/2) - max(abs(track_Z) - track_Sz/2, abs(detection.ZTV) - detection.Sz/2);
